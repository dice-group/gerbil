...
public class GoldStdEvalTest extends AbstractExperimentTaskTest {
    ...
    private static final EvaluatorFactory EVALUATOR_FACTORY = RootConfig
            .createEvaluatorFactory(RootConfig.createSubClassInferencer(), null);
...
//        ConfidenceBasedFMeasureCalculator.setPrintDebugMsg(false);
    ...
    public void test() {
        ...
        case SWC1: {
            expectedResults.put(ModelComparator.F1_SCORE_NAME, 1.0);
            expectedResults.put(ModelComparator.PRECISION_NAME, 1.0);
        ...
        default:
            Assert.fail("This test is not correctly configured!");
        }
