...
/**
 * This is a similar test to {@link CompoundMatchingsCounterTest} but with a
 * reversed order of the matching counters.
 * 
 * @author Michael R&ouml;der <roeder@informatik.uni-leipzig.de>
 * 
 */
public class CompoundMatchingsCounterTest2 extends AbstractMatchingsCounterTest<NamedEntity> {
    ...
    public CompoundMatchingsCounterTest2() {
        super(new CompoundMatchingsCounter<NamedEntity>(new MeaningMatchingsCounter<NamedEntity>(),
