...
public class CompoundMatchingsSearcherTest extends AbstractMatchingsCounterTest<NamedEntity> {
    ...
    public CompoundMatchingsSearcherTest() {
        super(new CompoundMatchingsSearcher<NamedEntity>(new StrongSpanMatchingsSearcher<NamedEntity>(),
                new ClassifierBasedMeaningMatchingsSearcher<NamedEntity>()), EXAMPLES);
    }
}
