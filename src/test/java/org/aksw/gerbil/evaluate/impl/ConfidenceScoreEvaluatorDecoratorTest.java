	...
	public static Collection<Object[]> data() {
		...
		testConfigs.add(new Object[] {
				new NamedEntity[][] { { new ScoredNamedEntity(0, 1, WRONG_MARKING, 0.1),
						...
						new ScoredNamedEntity(0, 1, CORRECT_MARKING, 0.3) } }, 1.0, new Double(0.2) });
		testConfigs.add(new Object[] {
				new NamedEntity[][] {
						{ new ScoredNamedEntity(0, 1, WRONG_MARKING, 0.1) },
						{ new ScoredNamedEntity(0, 1, CORRECT_MARKING, 0.2),
								new ScoredNamedEntity(0, 1, CORRECT_MARKING, 0.3) } }, 1.0, new Double(0.2) });
		testConfigs.add(new Object[] {
				new NamedEntity[][] { { new ScoredNamedEntity(0, 1, CORRECT_MARKING, 0),
						new ScoredNamedEntity(0, 1, WRONG_MARKING, 0.2),
						new ScoredNamedEntity(0, 1, WRONG_MARKING, 0.3) } }, 1.0 / 3.0, new Double(0) });
		testConfigs.add(new Object[] {
				new NamedEntity[][] { { new ScoredNamedEntity(0, 1, CORRECT_MARKING, 0),
		...
		testConfigs.add(new Object[] {
				new NamedEntity[][] { { new ScoredNamedEntity(0, 1, WRONG_MARKING, 0.1),
						new NamedEntity(0, 1, CORRECT_MARKING), new NamedEntity(0, 1, CORRECT_MARKING) } }, 1.0,
				new Double(1.0) });
		return testConfigs;
	}
