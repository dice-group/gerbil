...
public class P2KBTest extends AbstractExperimentTaskTest {
    ...
    public static Collection<Object[]> data() {
        ...
        testConfigs
                .add(new Object[] {
                        new Document[] {
                                new DocumentImpl(TEXTS[0], "http://qa.gerbil.aksw.org/QALD_Test_dataset/question#101",
                                        Arrays.asList((Marking) new Property("http://dbpedia.org/ontology/country"),
                                                (Marking) new Property(
...
//                GOLD_STD, Matching.STRONG_ENTITY_MATCH, new double[] { 0.5, 1.0, 2d / 3d, 0.5, 1.0, 2d / 3d, 0 } });
    ...
    public P2KBTest(Document[] annotatorResults, DatasetConfiguration dataset, Matching matching,
    ...
    public void test() {
        ...
        runTest(experimentTaskId, experimentDAO, new EvaluatorFactory(URI_KB_CLASSIFIER), configuration,
                new F1MeasureTestingObserver(this, ExperimentType.P2KB, experimentTaskId, experimentDAO,
                        expectedResults));
    }
}
