...
public class RE2KBTest extends AbstractExperimentTaskTest {
	...
	public RE2KBTest(Document[] annotatorResults, Document[] goldStandards, Matching matching,
	...
	public void test() {
		...
		ExperimentTaskConfiguration configuration = new ExperimentTaskConfiguration(
				new TestAnnotatorConfiguration(Arrays.asList(annotatorResults), ExperimentType.RE2KB),
				new TestDataset(Arrays.asList(goldStandards), ExperimentType.RE2KB), ExperimentType.RE2KB, matching);
