...
public class RE2KBTest extends AbstractExperimentTaskTest {
    ...
    public static Collection<Object[]> data() {
        ...
        testConfigs.add(new Object[] {
                new Document[] { new DocumentImpl(TEXTS[0], "http://qa.gerbil.aksw.org/QALD_Test_dataset/question#101",
                        Arrays.asList(
                                (Marking) new Relation(new Property("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),
                                        new Annotation("http://dbpedia.org/ontology/City")),
                                (Marking) new Relation(new Property("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),
                                        new Annotation("http://dbpedia.org/ontology/Town")),
                        (Marking) new Relation(new Property("http://dbpedia.org/ontology/country"),
                                new Annotation("http://dbpedia.org/resource/Germany")),
                        (Marking) new Relation(new Property("http://dbpedia.org/ontology/populationTotal"),
                                (Annotation) null))) },
        ...
        testConfigs.add(new Object[] {
                new Document[] { new DocumentImpl(TEXTS[0], "http://qa.gerbil.aksw.org/QALD_Test_dataset/question#101",
                        ...
                        (Marking) new Relation(new Property("http://dbpedia.org/ontology/populationTotal"),
                                (Annotation) null))) },
                GOLD_STD, Matching.STRONG_ENTITY_MATCH, new double[] { 1.0, 0.75, 6d / 7d, 1.0, 0.75, 6d / 7d, 0 } });
        // The system returns a correct answer type
        testConfigs.add(new Object[] {
                new Document[] { new DocumentImpl(TEXTS[0], "http://qa.gerbil.aksw.org/QALD_Test_dataset/question#101",
                        Arrays.asList(
                                (Marking) new Relation(new Property("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),
                                        new Annotation("http://dbpedia.org/ontology/City")),
                                (Marking) new Relation(new Property("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),
                                        new Annotation("http://example.org/WrongType")),
                        (Marking) new Relation(new Property("http://dbpedia.org/ontology/country"),
                                new Annotation("http://dbpedia.org/resource/Germany")),
                        (Marking) new Relation(new Property("http://dbpedia.org/ontology/populationTotal"),
                                (Annotation) null))) },
                GOLD_STD, Matching.STRONG_ENTITY_MATCH, new double[] { 0.75, 0.75, 0.75, 0.75, 0.75, 0.75, 0 } });
        return testConfigs;
    }
    ...
    public RE2KBTest(Document[] annotatorResults, DatasetConfiguration dataset, Matching matching,
    ...
    public void test() {
        ...
        runTest(experimentTaskId, experimentDAO, new EvaluatorFactory(URI_KB_CLASSIFIER), configuration,
                new F1MeasureTestingObserver(this, ExperimentType.RE2KB, experimentTaskId, experimentDAO,
                        expectedResults));
    }
}
