...
public class OKEChallengeTask1Test extends AbstractExperimentTaskTest {
    ...
    private static final DatasetConfiguration GOLD_STD = new NIFFileDatasetConfig("OKE_Task1",
            "src/test/resources/OKE_Challenge/example_data/task1.ttl", false, ExperimentType.OKE_Task1, null, null);
    ...
    public void test() {
        ...
        ExperimentTaskConfiguration configuration = new ExperimentTaskConfiguration(
                new TestAnnotatorConfiguration(Arrays.asList(annotatorResults), ExperimentType.OKE_Task1), dataset,
                ExperimentType.OKE_Task1, matching);
