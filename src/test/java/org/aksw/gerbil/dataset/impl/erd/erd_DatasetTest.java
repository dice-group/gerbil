...
//        generateTerminalOutputForLoadedErdDatasets();
    ...
    public void checkTrecData() {
        ...
        int min = 5;
        int max = 10;
        List<erd_Trec> treclist = new ArrayList();
        ...
        for (erd_Trec trec : treclist) assertThat(trec, is(notNullValue()));
    ...
    private static void loadDatasets() throws GerbilException {
        ...
        erd_Dataset dataset = new erd_Dataset(ERD_DATASET_PATH + TEXT_FILE, ERD_DATASET_PATH + ANNOTATION_FILE);
