...
public class MasakhaNERDatasetTest extends AbstractGenericCoNLLDatasetTest {
    ...
    public static Collection<Object[]> data() {
        ...
        testConfigs.add(new Object[] {
                ...
                new TypedSpanImpl(57, 13, "http://dbpedia.org/ontology/Location"), 0, 0 });
        ...
        testConfigs.add(new Object[] {
                ...
                new TypedSpanImpl(1, 62, "http://dbpedia.org/ontology/Organization"), 0, 0 });
        // Swahili language
        testConfigs.add(new Object[] {
                "Hii O\n ni O\n baada O\n ya O\n rais O\n Yoweri B-PER\n Museveni I-PER\n kuongeza O\n mda O\n wa O\n amri O\n karibu O\n 36 O\n alizotoa O\n katika O\n juhudi O\n za O\n kukabiliana O\n na O\n maambukizi O\n ya O\n Corona O\n nchini O\n humo O\n kwa O\n wiki B-DATE\n tatu I-DATE\n zaidi O\n kuanzia O\n leo O\n jumanne B-DATE\n . O\n",
                ...
                new TypedSpanImpl(21, 15, "http://dbpedia.org/ontology/Person"), 0, 0 });
        // Wolof language
        testConfigs.add(new Object[] {
        		...
        		new TypedSpanImpl(1, 17, "http://dbpedia.org/ontology/Person"), 0, 0 });
        // Yoruba language
        testConfigs.add(new Object[] {
        		...
        		new TypedSpanImpl(30, 6, "http://dbpedia.org/ontology/Place"), 0, 0 });
        // Bambara language
        testConfigs.add(new Object[] {
        		...
        		new TypedSpanImpl(46, 4, "http://dbpedia.org/ontology/Person"), 0, 0 });
        // Ghomala language
        testConfigs.add(new Object[] {
        		...
        		new TypedSpanImpl(37, 7, "http://dbpedia.org/ontology/Person"), 0, 0 });
        // Ewe language
        testConfigs.add(new Object[] {
        		...
        		new TypedSpanImpl(30, 12, "http://dbpedia.org/ontology/Place"), 0, 0 });
        // Fon language
        testConfigs.add(new Object[] {
        		...
        		new TypedSpanImpl(22, 4, "http://dbpedia.org/ontology/Place"), 0, 0 });
        // Mossi language
        testConfigs.add(new Object[] {
        		...
        		new TypedSpanImpl(10, 5, "http://dbpedia.org/ontology/Place"), 0, 0 });
        // Chichewa language
        testConfigs.add(new Object[] {
        		...
        		new TypedSpanImpl(44, 17, "http://dbpedia.org/ontology/Organization"), 0, 0 });
        // Setswana language
        testConfigs.add(new Object[] {
        		"Zuma B-PER o O ipolela O a O se O molato O. O",
        		"Zuma o ipolela a se molato.",
        		new TypedSpanImpl(1, 4, "http://dbpedia.org/ontology/Person"), 0, 0 });
        ...
        testConfigs.add(new Object[] {
        		...
        		new TypedSpanImpl(1, 5, "http://dbpedia.org/ontology/Person"), 0, 0 });
        // isiXhosa language
        testConfigs.add(new Object[] {
        		...
        		new TypedSpanImpl(51, 7, "http://dbpedia.org/ontology/Organization"), 0, 0 });
        // isiZulu language
        testConfigs.add(new Object[] {
        		"IMeya O yeTheku B-LOC ingenelela O enkingeni O yombhikisho O",
        		"IMeya yeTheku ingenelela enkingeni yombhikisho",
        		new TypedSpanImpl(6, 7, "http://dbpedia.org/ontology/Place"), 0, 0 });
