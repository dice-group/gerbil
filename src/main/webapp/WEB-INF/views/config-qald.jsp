			...
			<div class="row">
            			...
            			<div class="form-group">
            				<div class="col-md-2"></div>
            					...
            					<a title="You can upload a QALD-formatted XML or JSON file which has the answers to one of the datasets. NOTE: First, type in the name of your system if you use option 2 or 3 and then type in the URI.">
            						<span class="glyphicon glyphicon-question-sign"></span>
            					</a>
            				</div>
            				<div class="col-md-4">
		...
		function loadDatasets() {
			...
			$.getJSON('${datasets}', {
				...
				addDataToSelect('#answerFileDataset', data);
                                if (data.length === 1) {
                                    $('#dataset').multiselect('select', data[0]);
                                    $('#answerFileDataset').multiselect('select', data[0]);
                                }
			});
		}
