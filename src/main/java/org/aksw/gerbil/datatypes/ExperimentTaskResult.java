...
public class ExperimentTaskResult {
	...
	public ExperimentTaskResult(String annotator, String dataset, ExperimentType type, Matching matching, double results[], int state, int errorCount, long timestamp) {
	...
	public ExperimentTaskResult(String annotator, String dataset, ExperimentType type, Matching matching, double results[], int state, int errorCount) {
	...
	public ExperimentTaskResult(ExperimentTaskConfiguration configuration, double results[], int state, int errorCount) {
		this(configuration.annotatorConfig.getAnnotatorName(), configuration.datasetConfig.getDatasetName(), configuration.type, configuration.matching, results, state, errorCount, (new java.util.Date()).getTime());
	}
