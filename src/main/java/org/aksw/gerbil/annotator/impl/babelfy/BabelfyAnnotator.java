 ...
 * </p>
 * 
 * @deprecated Removed from the QA branch
 */
@Deprecated
public class BabelfyAnnotator /*extends AbstractAnnotator implements A2KBAnnotator*/ {
    ...
    // "org.aksw.gerbil.annotators.Babelfy.configFile";
    ...
    //
    // @Override
    // public List<Meaning> performC2KB(Document document) throws
    // GerbilException {
    // return sendRequest(document, false).getMarkings(Meaning.class);
    // }
    //
    // @Override
    // public List<MeaningSpan> performA2KBTask(Document document) throws
    // GerbilException {
    // return sendRequest(document, false).getMarkings(MeaningSpan.class);
    // }
    //
    // @Override
    // public List<MeaningSpan> performD2KBTask(Document document) throws
    // GerbilException {
    // return sendRequest(document, true).getMarkings(MeaningSpan.class);
    // }
    //
    // @Override
    // public List<Span> performRecognition(Document document) throws
    // GerbilException {
    // return sendRequest(document, false).getMarkings(Span.class);
    // }
    //
    // protected Document sendRequest(Document document, boolean useSpans)
    // throws GerbilException {
    // Document resultDoc = new DocumentImpl(document.getText(),
    ...
    // && (span.getStartPosition() + span.getLength()) < prevChars +
    // chunk.length()) {
    // constraints
    // .addFragmentToDisambiguate(new CharOffsetFragment(span.getStartPosition()
    // - prevChars,
    // (span.getStartPosition() + span.getLength()) - 1 - prevChars));
    // }
    // }
    // }
    // List<SemanticAnnotation> bfyAnnotations = sendRequest(bfy, chunk,
    // constraints);
    //
    // for (SemanticAnnotation bfyAnn : bfyAnnotations) {
    // resultDoc.addMarking(new ScoredNamedEntity(prevChars +
    // bfyAnn.getCharOffsetFragment().getStart(),
    ...
    // }
    //
    // protected synchronized List<SemanticAnnotation> sendRequest(IBabelfy bfy,
    // String chunk,
    ...
    // while ((nextEnd >= 0) && ((text.length() - nextEnd) >
    // BABELFY_MAX_TEXT_LENGTH)) {
