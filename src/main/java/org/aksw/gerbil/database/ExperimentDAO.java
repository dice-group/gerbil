...
public interface ExperimentDAO extends Closeable {
	...
	public Map<String, Object> getDatasetDetails(String experimentId);
	 ...
	 String getTaskId(String experimentId);

	/**
	 * Retrieves all experiment tasks from the database that have an explanation URL
	 * but have not yet been updated with actual explanation results (pruneCEL or LLM).
	 *
	 ...
	 *
	 * @param taskId the ID of the experiment task to update
	 * @param url the explanation URL associated with this task
	 * @param llmExplanation the explanation text generated by the LLM (e.g., GPT)
	 * @param pruneExplanation the explanation text generated by the pruneCEL algorithm
	 */
	void setUpdateExplanation(String taskId, String url, String llmExplanation, String pruneExplanation);
