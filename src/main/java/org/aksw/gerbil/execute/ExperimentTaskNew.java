 ...
 *
 */
public class ExperimentTaskNew implements Task {

	private static final Logger LOGGER = LoggerFactory.getLogger(ExperimentTaskNew.class);
	...
	public ExperimentTaskNew(int experimentTaskId, ExperimentDAO experimentDAO, SameAsRetriever globalRetriever,
	...
	public void run() {
		...
		try {
			...
			// store result
			experimentDAO.setExperimentTaskResultNew(experimentTaskId, expResult);
