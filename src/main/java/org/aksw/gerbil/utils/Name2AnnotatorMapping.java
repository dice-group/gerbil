...
public class Name2AnnotatorMapping {
    ...
    // public static final String ANNOTATOR_NAMES[] = new String[] { BabelfyAnnotatorConfig.ANNOTATOR_NAME,
    // NIFWebserviceAnnotatorConfiguration.ANNOTATOR_NAME, SpotlightAnnotatorConfig.ANNOTATOR_NAME,
    // TagMeAnnotatorConfig.ANNOTATOR_NAME, WikipediaMinerAnnotatorConfig.ANNOTATOR_NAME };
