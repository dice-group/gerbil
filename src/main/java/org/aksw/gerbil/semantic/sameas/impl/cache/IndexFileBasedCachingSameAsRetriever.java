...
public class IndexFileBasedCachingSameAsRetriever extends AbstractSameAsRetrieverDecorator {
    ...
    public static IndexFileBasedCachingSameAsRetriever create(SameAsRetriever decoratedRetriever,
        ...
        return new IndexFileBasedCachingSameAsRetriever(decoratedRetriever, uriSetIdMapping, sets, requestEntitiesNotFound,
    ...
    protected IndexFileBasedCachingSameAsRetriever(SameAsRetriever decoratedRetriever,
