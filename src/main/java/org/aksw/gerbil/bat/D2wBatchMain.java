...
//		D2WSystem miner = new WikipediaMinerAnnotator("/home/benchmark/bat-framework/dist/benchmark/configs/wikipediaminer/config.xml");
//		D2WSystem aidaLocal = new AIDALocalAnnotator("/home/benchmark/bat-framework/dist/benchmark/configs/aida/config.xml", wikiApi);
//		D2WSystem aidaPrior = new AIDAPriorityOnlyAnnotator("/home/benchmark/bat-framework/dist/benchmark/configs/aida/config.xml", wikiApi);
//		D2WSystem aidaCocktail = new AIDACockailPartyAnnotator("/home/benchmark/bat-framework/dist/benchmark/configs/aida/config.xml", wikiApi);
...
//		D2WDataset aquaintDs = new AQUAINTDataset("benchmark/datasets/AQUAINT/RawTexts", "/home/benchmark/bat-framework/dist/benchmark/datasets/AQUAINT/Problems", wikiApi);
//		D2WDataset aidaDs = new ConllAidaDataset("/home/benchmark/bat-framework/dist/benchmark/datasets/aida/AIDA-YAGO2-dataset.tsv", wikiApi);
//		D2WDataset msnbcDs = new MSNBCDataset("benchmark/datasets/MSNBC/RawTextsSimpleChars_utf8", "/home/benchmark/bat-framework/dist/benchmark/datasets/MSNBC/Problems", wikiApi);
		D2WDataset iitbDs = new IITBDataset("benchmark/datasets/iitb/crawledDocs", "benchmark/datasets/iitb/CSAW_Annotations.xml", wikiApi);
...
//		matchRelationsA2W.add(mam);
		...
		Pair<Float, MetricsResultSet> p =  RunExperiments.getBestRecord(resD2W, sam.getName(), agdistis.getName(), iitbDs.getName());
		System.out.printf("The best micro-F1 for %s on %s is achieved with a threshold of $.3f. Its value is %.3f.%n",agdistis.getName(), iitbDs.getName(), p.first, p.second.getMicroF1());
