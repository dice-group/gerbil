...
public class MainController {
	...
	public @ResponseBody String experimentoverview(@RequestParam(value = "experimentType") String experimentType, @RequestParam(value = "matching") String matching) {
		LOGGER.debug("Got request on /experimentoverview");
//		List<ExperimentTaskResult> results = dao.getMostRecentResults(id);
