    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        case XML_DS_TagDef.ENT_NM_LABEL_CODE: {
            if (currentNE != null) {
                ...
                LOGGER.error("Found a \"" + tagDef.getEntity_name_label() + "\" tag outside of a \"" + tagDef.getMark_label()
        ...
        case XML_DS_TagDef.ENT_URI_LABEL_CODE: {
            if (currentNE != null) {
                ...
                LOGGER.error("Found a \"" + tagDef.getEntity_uri_label() + "\" tag outside of a \"" + tagDef.getMark_label()
                        + "\" tag. It will be ignored.");
            }
            break;
        }
