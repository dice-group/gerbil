...
CREATE TABLE IF NOT EXISTS ExperimentTasks_Explanations (
...
CREATE TABLE IF NOT EXISTS ExplanationRequests (
    id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "experimentId" VARCHAR(255) NOT NULL,
    "explanationUrl" VARCHAR(255) NOT NULL,
    time_taken INT NOT NULL,
    positive LONGVARCHAR,
    negative LONGVARCHAR,
    "llm_result" LONGVARCHAR,
    "prunecl_result" LONGVARCHAR,
